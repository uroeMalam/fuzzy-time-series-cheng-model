...
<div class="container-fluid mt--6">
    <div class="information d-flex flex-column">
        <div class=" flex-row text-secondary">
            <h3 class="fw-bold" style="margin-left: 0.3em">Forecasting Pengiriman Barang</h3>
        </div>
        <div class="row px-1 mb-2">
            <div class="card bg-light mb-3">
                <div class="card-body">
                    {{-- start top --}}
                    <P>Silahkan Isi Nilai Kolom Dibawah Untuk Memulai perhitungan!</P>                  
                    <div class="row">
                        {{-- d1 --}}
                        <div class="col-sm-3">
...
<hr>
                    <br><br>
                    <p><b>Penentuan Himpunan Semesta</b></p>
                    {{-- start table --}}
                    <div class="row">
                        {{-- table --}}
                        <div class="col-sm-8">
...
<hr>
                    <br><br>
                    <p><b>Menentukan Panjang Interval</b></p>
                    <div class="row mx-2 text-center">
                        <div class="col-4">
                            <b>Panjang Interval</b><br>
                            <small>Rumus:  n = 1 + 3,322 log (N)</small>
                            <h1 id="n">0</h1>
                        </div>
                        <div class="col-4">
                            <b>Rentang Range </b><br>
                            <small>Rumus:  r = (Xmax + d2) - (Xmin - d1)</small>
                            <h1 id="r">0</h1>
                        </div>
                        <div class="col-4">
                            <b>Lebar Interval</b><br>
                            <small>Rumus:  i = r / n</small>
                            <h1 id="i">0</h1>
                        </div>
                    </div>
                    <br>
...
<hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <p class="ml-2"><b>Membentuk Fuzzy Logistik  (FLR)</b></p>
                            <br>
                            <table class="table table-striped table-warning table-fuzifikasi" style="text-align: center">
                                <thead>
                                  <tr>
...
<hr>
                    <br><br>
                    <p><b>Membentuk Fuzzy Logistik group (FLRG)</b></p>
                    <br>
...
<hr>
                    <br><br>
                    <p><b>Peramalan Dalam Beberapa Bulan Yang Akan Datang Berdsarkan Banyaknya Nilai Yang Di Input:</b></p>
                    <br>
                    <table class="table table-striped table-warning table-hasil" style="text-align: center">
                        <thead>
                          <tr>
